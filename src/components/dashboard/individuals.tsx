...
const DashboardIndividualAssets: React.FC = () => {
  return (
    <section className="mt-10 mb-10 w-screen px-32">
      {/* Section title */}
      <h5 className="circularBold text-4xl text-white">Individual Assets</h5>
...
export default DashboardIndividualAssets;
